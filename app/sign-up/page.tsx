  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <motion.div
        ...
        className="bg-white shadow-lg rounded-2xl md:p-8 p-4 w-full max-w-md"
      >
        ...
        <form className="space-y-4">
          ...
          {/* Show extra doctor fields when Doctor is selected */}
          {role === "doctor" && (
            <input
              type="text"
              placeholder="Medical License Number"
              className="w-full px-4 py-3 border rounded-lg focus:outline-none focus:border-[#19C37D]"
            />
          )}
        ...
        <p className="text-center mt-5 text-sm text-gray-600">
          ...
          <Link href="/sign-in" className="text-[#0B7EBE] font-semibold hover:underline">
            Sign In
          </Link>
        </p>
      </motion.div>
